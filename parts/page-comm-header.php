		...
		<div class="row">
			...
			<div class="col-md-4 kill-padding">
				<div class="gen-contract text-center">
					<h1 class="text-white text-uppercase text-center h3 font-weight-bold">General<br /> Contractors</h1>
			...
			<div class="col-md-4 kill-padding">
				<div class="managers text-center">
					<h1 class="text-white text-uppercase text-center h3 font-weight-bold">Facility<br /> Managers</h1>
