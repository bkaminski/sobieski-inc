...
{
    global $post;
    return $output . '<a class="btn btn-outline-sobieski text-uppercase rounded-0" href="' . get_permalink() . '">Read More <i class="fas fa-angle-double-right fa-fw fa-lg"></i></a>';
}
